    ...
    <div class="row">
        <div class="form-horizontal col-md-offset-3" role="form"
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <i class="fa fa-lock fa-lg"></i>
                    <input class="form-control required" type="password" placeholder="Re_Password" id="repassword"
                           name="repassword" maxlength="8"/>
                </div>
                <div class="form-group col-md-offset-9">
                    <button type="submit" class="btn btn-primary btn-block" name="submit">注册</button>
                </div>
            </div>
        </div>
    </div>
